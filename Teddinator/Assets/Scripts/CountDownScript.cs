...
public class CountDownScript : MonoBehaviour {
	...
	IEnumerator SlowDown(float timer)
	{
		...
		ScrollingScript ssss = GameObject.Find ("_cloulds_Big").GetComponent<ScrollingScript> ();
		ScrollingScript sssss = GameObject.Find ("_foreground_trees").GetComponent<ScrollingScript> ();
